    ...
    return (
        ...
        >
            <Form className="space-y-3">
                {error && (
                    <div className="flex items-center gap-2 rounded-3xl border border-red-200 bg-red-50 p-2.5 text-xs font-medium text-red-700">
                        <span>⚠️</span>
                        <span>{error}</span>
                    </div>
                )}
                {success && (
                    <div className="flex items-center gap-2 rounded-3xl border border-green-200 bg-green-50 p-2.5 text-xs font-medium text-green-700">
                        <span>✅</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <Field
                            name="username"
                            className="w-full rounded-3xl border border-slate-200 bg-slate-50/60 px-3 py-2 text-xs outline-none transition-all focus:border-sky-600 focus:bg-white focus:ring-1 focus:ring-sky-200"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        <label className="mb-1 block text-xs font-semibold text-slate-700">Xác nhận mật khẩu</label>
                        <Field
                ...
                <div className="flex items-center justify-between text-xs text-slate-500">
                    <label className="flex items-center gap-1.5 cursor-pointer">
                        <input
                            ...
                            className="h-3.5 w-3.5 rounded-sm accent-sky-800"
                        />
                ...
                <button
                    type="submit"
                    disabled={submitting}
                    className="w-full rounded-3xl bg-sky-800 py-2.5 text-sm font-bold text-white shadow-md shadow-sky-900/20 transition-all hover:bg-sky-900 active:scale-[0.99] disabled:opacity-60 cursor-pointer disabled:cursor-not-allowed"
                >
                ...
                <div className="pt-1 text-center text-xs text-slate-600">
                    ...
                    {onSwitchLogin ? (
                        ...
                        <LoadingLink to="/login" className="font-bold text-sky-800 hover:underline">
                            Đăng nhập
                        </LoadingLink>
                    )}
                </div>
